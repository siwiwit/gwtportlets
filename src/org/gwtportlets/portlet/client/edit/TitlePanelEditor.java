...
/**
 * Editor for a CaptionPanel. Adds option to open dialog to edit caption
 * settings.
 */
public class TitlePanelEditor extends DefaultWidgetEditor {

    public TitlePanelEditor() {
    }
        ...
        bar.addItem("Edit Title...", new Command() {
            public void execute() {
                manager.displayEditWidgetDialog(widget,
                        new TitlePanelDialog((TitlePanel)widget));
            }
